...
/* ============================================================
   GROUP_SUBJECTS — "সাইন্স গ্রুপ"/"কমার্স গ্রুপ"/"আর্টস গ্রুপ" চেকবক্স টিক দিলে
   কোন কোন বিষয় অটো-সিলেক্ট হবে (যেসব রেঞ্জে যেসব সাবজেক্ট নামে না মেলে, সেখানে
   স্বয়ংক্রিয়ভাবে ইন্টারসেকশন নেওয়া হয়, কোনো এরর হবে না — script.js দেখুন)
============================================================ */
const GROUP_SUBJECTS = {
  "সাইন্স গ্রুপ": ["পদার্থবিজ্ঞান", "রসায়ন", "জীববিজ্ঞান", "উচ্চতর গণিত", "বাংলাদেশ ও বিশ্বপরিচয়"],
  "কমার্স গ্রুপ": ["হিসাববিজ্ঞান", "ব্যবসায় উদ্যোগ", "ফিন্যান্স ও ব্যাংকিং"],
  "আর্টস গ্রুপ": ["ইতিহাস", "ভূগোল ও পরিবেশ", "পৌরনীতি ও নাগরিকতা", "অর্থনীতি"]
};

// "এডমিশন টেস্ট" রেঞ্জের ফিক্সড বিষয়-তালিকা — এইচএসসি ৩ গ্রুপের বিষয়সমূহ + সাধারণ কয়েকটা বিষয়
// (এটা কোনো প্রকৃত ক্লাসের সাথে ম্যাপ হয় না, তাই Admission_Test_Subjects নামে আলাদা ফিল্ড হিসেবে জমা হয়)
const ADMISSION_TEST_SUBJECTS = [
  "পদার্থবিজ্ঞান", "রসায়ন", "জীববিজ্ঞান", "উচ্চতর গণিত",
  "হিসাববিজ্ঞান", "ফিন্যান্স ব্যাংকিং ও বিমা", "ব্যবসায় সংগঠন ও ব্যবস্থাপনা", "উৎপাদন ব্যবস্থাপনা ও বিপণন",
  "ইতিহাস", "ইসলামের ইতিহাস ও সংস্কৃতি", "ভূগোল", "পৌরনীতি ও সুশাসন", "যুক্তিবিদ্যা", "সমাজবিজ্ঞান", "সমাজকর্ম",
  "অর্থনীতি", "কৃষি শিক্ষা", "গার্হস্থ্য বিজ্ঞান",
  "ইংরেজি", "বাংলা", "তথ্য ও যোগাযোগ প্রযুক্তি (ICT)", "পরিসংখ্যান", "সাধারণ জ্ঞান"
];
...
/* ============================================================
   ...
   তাই Teachable_Classes/matching-এ যোগ হয় না, আলাদা ফিল্ড (Admission_Test_Subjects)
   হিসেবে জমা হয় (script.js-এর applyRangeSelection দেখুন)
============================================================ */
const CLASS_RANGES = {
  "বাংলা মিডিয়াম (BM)": [
