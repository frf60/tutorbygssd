...
const SUBJECTS_DATA = {
  ...
  "ভোকেশনাল/পলিটেকনিক": {
    ...
    "এইচএসসি ভোকেশনাল/বিএম ১ম বর্ষ": [
      "কম্পিউটার অফিস অ্যাপ্লিকেশন", "হিসাববিজ্ঞান নীতি ও প্রয়োগ", "ফিন্যান্স ব্যাংকিং ও বিমা", "মার্কেটিং নীতি ও প্রয়োগ", "উদ্যোক্তা উন্নয়ন", "বাংলা", "ইংরেজি", "গণিত", "তথ্য ও যোগাযোগ প্রযুক্তি (ICT)"
    ],
    "এইচএসসি ভোকেশনাল/বিএম ২য় বর্ষ": [
      "কম্পিউটার অফিস অ্যাপ্লিকেশন", "হিসাববিজ্ঞান নীতি ও প্রয়োগ", "ফিন্যান্স ব্যাংকিং ও বিমা", "মার্কেটিং নীতি ও প্রয়োগ", "উদ্যোক্তা উন্নয়ন", "বাংলা", "ইংরেজি", "গণিত", "তথ্য ও যোগাযোগ প্রযুক্তি (ICT)"
    ]
  }
};
